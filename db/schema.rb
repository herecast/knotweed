...
ActiveRecord::Schema.define(version: 20181016143456) do
  ...
  create_table "business_categories_business_categories", id: false, force: :cascade do |t|
    t.bigint "parent_id"
    t.bigint "child_id"
    t.index ["parent_id", "child_id"], name: "idx_16427_business_categories_index", unique: true, using: :btree
  end
  ...
  create_table "business_profiles", id: :bigserial, force: :cascade do |t|
    ...
    t.index ["source", "source_id"], name: "idx_16451_index_business_profiles_on_source_and_source_id", using: :btree
  end
  ...
  create_table "content_categories_organizations", id: false, force: :cascade do |t|
    ...
    t.bigint "organization_id"
    t.index ["content_category_id", "organization_id"], name: "idx_16559_index_on_content_category_id_and_publication_id", using: :btree
  end
  ...
  create_table "locations_locations", id: false, force: :cascade do |t|
    t.bigint "parent_id"
    t.bigint "child_id"
    t.index ["child_id", "parent_id"], name: "idx_16707_index_locations_locations_on_child_id_and_parent_id", using: :btree
    t.index ["child_id"], name: "idx_16707_index_locations_locations_on_child_id", using: :btree
    t.index ["parent_id", "child_id"], name: "idx_16707_index_locations_locations_on_parent_id_and_child_id", using: :btree
  ...
  create_table "roles", id: :bigserial, force: :cascade do |t|
    ...
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
    t.index ["name", "resource_type", "resource_id"], name: "idx_16837_index_roles_on_name_and_resource_type_and_resource_id", using: :btree
  ...
  create_table "users_roles", id: false, force: :cascade do |t|
    t.bigint "user_id"
    t.bigint "role_id"
    t.index ["user_id", "role_id"], name: "idx_16873_index_users_roles_on_user_id_and_role_id", using: :btree
  end
