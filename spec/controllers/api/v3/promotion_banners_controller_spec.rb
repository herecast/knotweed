...
describe Api::V3::PromotionBannersController do
  ...
  describe 'GET track_click' do
    ...
    subject! { get :track_click, promotion_banner_id: @banner.id,  content_id: @content.id, format: :json }
    ...
    context 'with invalid content id' do
      subject! { get :track_click, promotion_banner_id: @banner.id, content_id: @content.id + 200, format: :json }
    ...
    context 'with invalid promotion_banner_id' do
      subject! { get :track_click, promotion_banner_id: @banner.id + 201, content_id: @content.id, format: :json }
      it 'should return 422' do
        response.status.should eq 422
      end
    end
