  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved promotion as @promotion" do
        ...
        post :create, {:promotion => { "active" => "invalid value" }}, valid_session
        assigns(:promotion).should be_a_new(Promotion)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested promotion" do
        ...
        Promotion.any_instance.should_receive(:update_attributes).with({ "active" => "false" })
        put :update, {:id => promotion.to_param, :promotion => { "active" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the promotion as @promotion" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Promotion.any_instance.stub(:save).and_return(false)
        put :update, {:id => promotion.to_param, :promotion => { "active" => "invalid value" }}, valid_session
        assigns(:promotion).should eq(promotion)
      end
