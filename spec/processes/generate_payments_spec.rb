...
RSpec.describe GeneratePayments, freeze_time: true do
  ...
  describe 'with user payment recipient' do
    ...
    describe 'with valid ad impressions *not* in the period' do
      ...
      let!(:impression_out_of_period) { FactoryGirl.create :promotion_banner_metric, content: included_content,
    ...
    describe 'with valid ad impressions on two contents' do
      ...
      let!(:impression1) { FactoryGirl.create :promotion_banner_metric, content: included_content1,
        created_at: (period_end - 2.days) }
      let!(:impression2) { FactoryGirl.create :promotion_banner_metric, content: included_content2,
        created_at: (period_end - 2.days) }
