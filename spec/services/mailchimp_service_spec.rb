...
RSpec.describe MailchimpService do
  ...
  describe '.interest_categories' do
    context 'given a list id' do
      ...
      let!(:apistub) {
        stub_request(:get,
          "https://#{base_url}/lists/#{list_id}/interest-categories"
        ).with(
          basic_auth: auth,
          headers: {
            "Content-Type" => 'application/json',
  ...
  describe '.interests' do
    context 'given list id, and interest category id' do
      ...
      let!(:apistub) {
        stub_request(:get,
          "https://#{base_url}/lists/#{list_id}/interest-categories/#{interest_category_id}/interests"
        ).with(
          basic_auth: auth,
          headers: {
            "Content-Type" => 'application/json',
  ...
  describe '.merge_fields' do
    context 'given a list id' do
      ...
      let!(:apistub) {
        stub_request(:get,
          "https://#{base_url}/lists/#{list_id}/merge-fields"
        ).with(
          basic_auth: auth,
          headers: {
            "Content-Type" => 'application/json',
