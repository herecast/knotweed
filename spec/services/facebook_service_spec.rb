...
RSpec.describe FacebookService do
  ...
  let!(:successful_facebook_request) {
    stub_request(:get, "https://graph.facebook.com/v2.9/me?access_token=123123123123123&fields=email,%20name,%20verified,%20age_range,%20timezone,%20gender").
             with(:headers => {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Ruby'}).
                      to_return(:status => 200, :body => "", :headers => {})
  }
  
  let!(:failed_facebook_request) {
    stub_request(:get, "https://graph.facebook.com/v2.9/me?access_token=BadToken&fields=email,%20name,%20verified,%20age_range,%20timezone,%20gender").
             with(:headers => {'Accept'=>'*/*', 'Accept-Encoding'=>'gzip;q=1.0,deflate;q=0.6,identity;q=0.3', 'User-Agent'=>'Ruby'}).
