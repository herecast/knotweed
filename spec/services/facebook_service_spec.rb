...
RSpec.describe FacebookService do
  ...
  let!(:successful_facebook_request) do
  ...
  let!(:failed_facebook_request) do
  ...
  describe '::rescrape_url' do
    ...
    let!(:successful_facebook_profile_rescrape_request) do
    ...
    context 'when content_type=Event' do
      ...
      let!(:successful_facebook_event_rescrape_request) do
      ...
      let!(:successful_facebook_profile_event_rescrape_request) do
