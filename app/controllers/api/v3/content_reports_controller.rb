  ...
  module V3
    class ContentReportsController < ApiController
      ...
      def index
        ...
        query = "SELECT (r.report_date - INTERVAL '5' HOUR) as \"Date\", (CASE WHEN o.pay_directly = true THEN o.name ELSE u.name END) as \"Author\", (c.pubdate - INTERVAL '5' HOUR) as \"Publication Date\",
          c.title as \"Title\", r.view_count as \"Views\",
          r.banner_click_count as \"Ad Clicks\", (r.view_count + r.banner_click_count) * (round(CAST(float8 (o.pay_rate_in_cents/100.0) as numeric), 2)) as \"Payment\",
