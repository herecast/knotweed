namespace :import do
  ...
  task :vn_rss_backdated_imports, [:start_date, :organization, :content_set] => :environment do |t, args|
    ...
    while date < Date.today
      ...
      if args[:content_set]
        content_set = ContentSet.find_or_create_by_name(args[:content_set])
        rss_ij.content_set = content_set
      end
      rss_ij.save!
      rss_ij.enqueue_job
