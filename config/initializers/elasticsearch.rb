...
Searchkick.client = Elasticsearch::Client.new(
  ...
  unless ENV['ELASTICSEARCH_URL'].present? && ENV['ELASTICSEARCH_URL'].include?('localhost')
    if ENV['ELASTICSEARCH_URL'].present? && ENV['ELASTICSEARCH_URL'].include?('es.amazonaws.com')
