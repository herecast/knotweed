# RailsAdmin config file. Generated on June 11, 2013 12:17
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Knotweed', 'Admin']
  ...
  # config.excluded_models = ['Content', 'Issue', 'Location', 'Publication', 'Role', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Content', 'Issue', 'Location', 'Publication', 'Role', 'User']
  ...
  #     configure :issue, :belongs_to_association 
  ...
  #     configure :issue_id, :integer         # Hidden 
  ...
  #     configure :id, :integer 
  #     configure :issue_edition, :string 
  #     configure :publication_date, :date 
