Knotweed::Application.routes.draw do
  ...
  get 'business_locations/:id/edit_venue', to: 'business_locations#edit_venue', as: :edit_venue
  get 'business_locations/add_venue', to: 'business_locations#add_venue', as: :add_venue
